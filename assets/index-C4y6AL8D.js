 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ry{constructor(){this.changes=new Wt(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ve.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?b.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="WebChannelConnection",qn=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(s){setTimeout(()=>{throw s},0)}})};class cn extends Py{constructor(e){super(e),this.__=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static a_(){if(!cn.u_){const e=Tl();qn(e,El.STAT_EVENT,t=>{t.stat===Oi.PROXY?V(Ee,"STAT_EVENT: detected buffering proxy"):t.stat===Oi.NOPROXY&&V(Ee,"STAT_EVENT: detected no buffering proxy")}),cn.u_=!0}}Go(e,t,r,s,o){const a=zi();return new Promise((u,h)=>{const d=new _l;d.setWithCredentials(!0),d.listenOnce(yl.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Wr.NO_ERROR:const p=d.getResponseJson();V(Ee,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(p)),u(p);break;case Wr.TIMEOUT:V(Ee,`RPC '${e}' ${a} timed out`),h(new O(P.DEADLINE_EXCEEDED,"Request time out"));break;case Wr.HTTP_ERROR:const I=d.getStatus();if(V(Ee,`RPC '${e}' ${a} failed with status:`,I,"response text:",d.getResponseText()),I>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const k=S==null?void 0:S.error;if(k&&k.status&&k.message){const D=function(H){const q=H.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(q)>=0?q:P.UNKNOWN}(k.status);h(new O(D,k.message))}else h(new O(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new O(P.UNAVAILABLE,"Connection failed."));break;default:M(9055,{c_:e,streamId:a,l_:d.getLastErrorCode(),h_:d.getLastError()})}}finally{V(Ee,`RPC '${e}' ${a} completed.`)}});const m=JSON.stringify(s);V(Ee,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",m,r,15)})}P_(e,t,r){const s=zi(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Qo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");V(Ee,`Creating RPC '${e}' stream ${s}: ${d}`,u);const m=a.createWebChannel(d,u);this.T_(m);let p=!1,I=!1;const S=new Cy({jo:k=>{I?V(Ee,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(p||(V(Ee,`Opening RPC '${e}' stream ${s} transport.`),m.open(),p=!0),V(Ee,`RPC '${e}' stream ${s} sending:`,k),m.send(k))},Jo:()=>m.close()});return qn(m,$n.EventType.OPEN,()=>{I||(V(Ee,`RPC '${e}' stream ${s} transport opened.`),S.r_())}),qn(m,$n.EventType.CLOSE,()=>{I||(I=!0,V(Ee,`RPC '${e}' stream ${s} transport closed`),S.s_(),this.I_(m))}),qn(m,$n.EventType.ERROR,k=>{I||(I=!0,Ht(Ee,`RPC '${e}' stream ${s} transport errored. Name:`,k.name,"Message:",k.message),S.s_(new O(P.UNAVAILABLE,"The operation could not be completed")))}),qn(m,$n.EventType.MESSAGE,k=>{var D;if(!I){const N=k.data[0];Q(!!N,16349);const H=N,q=(H==null?void 0:H.error)||((D=H[0])==null?void 0:D.error);if(q){V(Ee,`RPC '${e}' stream ${s} received error:`,q);const K=q.status;let le=function(T){const g=se[T];if(g!==void 0)return eh(g)}(K),he=q.message;K==="NOT_FOUND"&&he.includes("database")&&he.includes("does not exist")&&he.includes(this.databaseId.database)&&Ht(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),le===void 0&&(le=P.INTERNAL,he="Unknown error status: "+K+" with message "+q.message),I=!0,S.s_(new O(le,he)),m.close()}else V(Ee,`RPC '${e}' stream ${s} received:`,N),S.o_(N)}}),cn.a_(),setTimeout(()=>{S.i_()},0),S}terminate(){this.__.forEach(e=>e.close()),this.__=[]}T_(e){this.__.push(e)}I_(e){this.__=this.__.filter(t=>t===e)}Qo(e,t,r){super.Qo(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return vl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function yu(n){n=It(n,ce);const e=It(n.firestore,ur),t=Bo(e);return vE(t,n._key).then(r=>Qh(e,n,r))}function Wh(n,e,t){n=It(n,ce);const r=It(n.firestore,ur),s=FE(n.converter,e),o=VE(r);return qE(r,[NE(o,"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,et.none())])}function Eu(n,...e){var d,m,p;n=ke(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||_u(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(_u(e[r])){const I=e[r];e[r]=(d=I.next)==null?void 0:d.bind(I),e[r+1]=(m=I.error)==null?void 0:m.bind(I),e[r+2]=(p=I.complete)==null?void 0:p.bind(I)}let o,a,u;if(n instanceof ce)a=It(n.firestore,ur),u=Ds(n._key.path),o={next:I=>{e[r]&&e[r](Qh(a,n,I))},error:e[r+1],complete:e[r+2]};else{const I=It(n,$s);a=It(I.firestore,ur),u=I._query;const S=new Hh(a);o={next:k=>{e[r]&&e[r](new ln(a,S,I,k))},error:e[r+1],complete:e[r+2]},UE(n._query)}const h=Bo(a);return TE(h,u,s,o)}function qE(n,e){const t=Bo(n);return IE(t,e)}function Qh(n,e,t){const r=t.docs.get(e._key),s=new Hh(n);return new qt(n,s,e._key,r,new zn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){vg(yn),dn(new jt("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ur(new Ag(r.getProvider("auth-internal")),new bg(a,r.getProvider("app-check-internal")),zg(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),Et(pu,gu,e),Et(pu,gu,"esm2020")})();const $E={apiKey:"AIzaSyCAMOaZZ9bP-ePX9-DbvG-FxLv0iLbjYBs",authDomain:"stickeralbum-513b5.firebaseapp.com",projectId:"stickeralbum-513b5",storageBucket:"stickeralbum-513b5.firebasestorage.app",messagingSenderId:"343627765709",appId:"1:343627765709:web:102e12668152ca10bb1684"},Jh=Lu($E),Zi=Eg(Jh),Zh=SE(Jh),jE=new Je,GE=["blue","red","purple","green","black"],zE=2.99;let Z=Nd(),es="all",Xh=!0,qe=null,hn=null,Tu="stickers",Ie=Dd(),Si=null;const HE=300;Object.entries(wu).forEach(([n,e])=>e.forEach(t=>{}));function jo(n){return Uh(Zh,"users",n,"data","stickers")}function Go(n){return Uh(Zh,"users",n,"data","pro")}async function zo(n){if(qe)try{await Wh(jo(qe.uid),{owned:n})}catch(e){console.error("Cloud sync failed",e)}}async function KE(){if(qe)try{await Wh(Go(qe.uid),{...Ie,uid:qe.uid})}catch(n){console.error("Pro status sync failed",n)}}function jr(){Zn(Z),Si&&clearTimeout(Si),Si=setTimeout(()=>{zo(Z)},HE)}function WE(n){hn&&hn(),hn=Eu(jo(n),e=>{if(e.exists()){const t=e.data().owned||{};Z=t,Zn(t),gt(),Ce()}},e=>console.error("Sync error",e)),Eu(Go(n),e=>{if(e.exists()){const t=e.data();Ie={purchased:t.purchased,purchaseDate:t.purchaseDate},Xi(Ie),js()}},e=>console.error("Pro sync error",e))}function QE(){hn&&(hn(),hn=null)}function Ho(n){return n.stickers.filter(e=>Z[xt(n.code,e.n)]&&Z[xt(n.code,e.n)]>0).length}function JE(){return Ie.purchased?Object.keys(Z).reduce((n,e)=>n+(Z[e]||0),0):Object.keys(Z).filter(n=>Z[n]).length}function ZE(n){const e=Ho(n),t=n.stickers.length;return es==="complete"?e===t:es==="incomplete"?e>0&&e<t:es==="none"?e===0:!0}function gt(){const n=JE(),e=Math.round(n/ts*100);document.getElementById("s-have").textContent=n,document.getElementById("s-need").textContent=ts-n,document.getElementById("s-pct").textContent=e+"%",document.getElementById("global-bar").style.width=e+"%"}function vu(n){const e=Ho(n),t=n.stickers.length,r=Math.round(e/t*100),s=document.createElement("div");s.className="team-card";const o=document.createElement("div");return o.className="team-header",o.setAttribute("role","button"),o.setAttribute("aria-label",`Open ${n.name} sticker album`),o.innerHTML=`
  ...
  `,o.addEventListener("click",()=>YE(n)),s.appendChild(o),s}function Ce(){const n=document.getElementById("search").value.toLowerCase().trim(),e=document.getElementById("teams-container");e.classList.remove("schedule-view"),e.innerHTML="";const t=Vd.filter(r=>r.name.toLowerCase().includes(n)||r.code.toLowerCase().includes(n)).filter(ZE);if(!t.length){e.innerHTML='<div class="empty-msg">No teams match your filter.</div>',gt();return}if(Xh){new Set(t.map(s=>s.code));const r=Object.fromEntries(t.map(s=>[s.code,s]));Object.entries(wu).forEach(([s,o])=>{const a=o.map(m=>r[m]).filter(Boolean);if(!a.length)return;const u=document.createElement("div");u.className="group-section";const h=document.createElement("div");h.className="group-header",h.textContent=s==="Special"?"★ Special":`Group ${s}`,u.appendChild(h);const d=document.createElement("div");d.className="teams-list",a.forEach(m=>d.appendChild(vu(m))),u.appendChild(d),e.appendChild(u)})}else{const r=document.createElement("div");r.className="teams-list",t.forEach(s=>r.appendChild(vu(s))),e.appendChild(r)}gt()}function XE(){const n=document.getElementById("teams-container");n.classList.add("schedule-view"),n.innerHTML="";const e=Intl.DateTimeFormat().resolvedOptions().timeZone,t={};Od.forEach(s=>{const o=new Date(s.date).toLocaleDateString("en-US");t[o]||(t[o]=[]),t[o].push(s)}),Object.keys(t).sort().forEach(s=>{const o=document.createElement("div");o.className="schedule-date-section";const a=document.createElement("div");a.className="schedule-date-header",a.textContent=new Date(s).toLocaleDateString("en-US",{weekday:"long",month:"short",day:"numeric"}),o.appendChild(a);const u=document.createElement("div");u.className="schedule-match-list",t[s].forEach(h=>{const d=new Date(h.date),m=new Date(d.toLocaleString("en-US",{timeZone:e})),p=document.createElement("div");p.className="schedule-match-card";const I=h.home.length===2&&Wa[h.home]||h.home,S=h.away.length===2&&Wa[h.away]||h.away,k=ns(h.home,24),D=ns(h.away,24),N=m.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!0});p.innerHTML=`
    ...
    `;const m=t.querySelector(".album-sticker-grid");n.stickers.forEach(p=>{const I=xt(n.code,p.n),S=Z[I]||0,k=S>0,D=document.createElement("div");D.className="album-sticker"+(k?" have":"")+(p.foil?" foil":""),D.setAttribute("role",Ie.purchased?"button":"checkbox"),D.setAttribute("aria-checked",String(k)),D.setAttribute("aria-label",`${n.code} ${p.n} ${p.t}`);let N="";Ie.purchased&&(N='<div class="album-sticker-parallels">',GE.forEach(q=>{const K=xt(n.code,p.n,q),le=Z[K]?1:0,he={blue:"#3b82f6",red:"#ef4444",purple:"#a855f7",green:"#22c55e",black:"#1f2937"}[q];N+=`<div class="parallel-dot" data-color="${q}" style="background-color: ${he}; opacity: ${le>0?1:.2};" title="${q}"></div>`}),N+="</div>");let H="";Ie.purchased&&S>0&&(H=`<div class="album-quantity-badge">${S}</div>`),D.innerHTML=`
      ...
      `,D.addEventListener("click",q=>{if(Ie.purchased&&q.target.classList.contains("parallel-dot")){const K=q.target.dataset.color,le=xt(n.code,p.n,K);a(n,p,le,K)}else Ie.purchased?a(n,p,I):(Z[I]?delete Z[I]:Z[I]=!0,jr(),o(),gt(),Ce())}),m.appendChild(D)}),t.querySelector(".album-close-btn").addEventListener("click",r),t.querySelector(".album-mark-all").addEventListener("click",()=>{n.stickers.forEach(p=>{Z[xt(n.code,p.n)]=1}),jr(),o(),gt(),Ce()}),t.querySelector(".album-clear-all").addEventListener("click",()=>{n.stickers.forEach(p=>{delete Z[xt(n.code,p.n)]}),jr(),o(),gt(),Ce()})}function a(u,h,d,m){const p=Z[d]||0,I=document.createElement("div");I.className="modal-overlay";const S=m?` (${m.toUpperCase()})`:"";I.innerHTML=`
  ...
  `,n.querySelector(".btn-cancel").addEventListener("click",()=>n.remove()),n.querySelector(".btn-confirm").addEventListener("click",async()=>{Ie={purchased:!0,purchaseDate:new Date().toISOString()},Xi(Ie),await KE(),n.remove(),js(),Ce()}),n.addEventListener("click",e=>{e.target===n&&n.remove()}),document.body.appendChild(n)}function js(){const n=document.getElementById("auth-section");n&&(qe?(n.innerHTML=`
      <div class="user-pill">
  ...
  `,n.querySelector(".btn-cancel").addEventListener("click",()=>n.remove()),n.querySelector(".btn-confirm").addEventListener("click",()=>{Z={},Zn(Z),zo(Z),n.remove(),Ce()}),n.addEventListener("click",e=>{e.target===n&&n.remove()}),document.body.appendChild(n)}function nT(){document.getElementById("app").innerHTML=`
    <header class="header">
